...
public class SalesController {
    ...
    public ObservableList<SalesController.CartItem> getCart() {
        return cart;
    }
    ...
    public void removeItemFromCart(SalesController.CartItem item) {
        cart.remove(item);
    }
    ...
    public File generateFormalLetter(Customer c) {
        ...
        if (c != null) {
            ...
            html.append(c.getAddress() != null ? c.getAddress() : "").append(",<br>\n");
            html.append(c.getTown() != null ? c.getTown() : "").append(",<br>\n");
            html.append(c.getPostcode() != null ? c.getPostcode() : "").append("\n");
        } else {
            html.append("Walk-in Customer,<br>\nN/A\n");
        }
        html.append("</div>\n<div class='company-info'>\n");
        html.append(settings != null && settings.getCompanyName() != null ? settings.getCompanyName() : "InfoPharma Ltd.").append(",<br>\n");
        html.append(settings != null && settings.getAddressLine1() != null ? settings.getAddressLine1() : "20 High St.").append(",<br>\n");
        html.append(settings != null && settings.getCity() != null ? settings.getCity() : "London").append(",<br>\n");
        html.append(settings != null && settings.getPostcode() != null ? settings.getPostcode() : "Kent").append("<br>\n");
        html.append("Phone: ").append(settings != null && settings.getPhone() != null ? settings.getPhone() : "0208 778 0124").append("<br>\n");
        ...
        html.append("<div class='sign-off'>Yours sincerely,<br><br>");
        html.append(settings != null && settings.getDirectorName() != null ? settings.getDirectorName() : "A. Petite").append("</div>\n");
        html.append("</div>\n</body>\n</html>\n");
    ...
    public ObservableList<SalesController.SaleRecord> getSalesLog() {
        return salesLog;
    }
