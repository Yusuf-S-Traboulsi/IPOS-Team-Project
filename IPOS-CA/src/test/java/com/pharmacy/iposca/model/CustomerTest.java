...
public class CustomerTest {
    ...
    public void testCustomerCreation() {
        Customer customer = new Customer(101, "Mr.", "John Smith", "123 Main St", "London", "SW1A 1AA", 1000.0, 0.0);
    ...
    public void testSetCurrentDebt() {
        Customer customer = new Customer(101, "Mr.", "Test", "Addr", "Town", "Post", 500.0, 0.0);
